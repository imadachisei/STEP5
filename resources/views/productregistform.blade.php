...
<head>
    ...
    <link href="{{ asset('css/ProductRegistForm.css') }}" rel="stylesheet">
...
<main>
    <div class="container">
        <div class="row">
            <h1>商品新規登録画面</h1>
            <form action="{{ route('ProductRegistSubmit') }}" method="post" enctype='multipart/form-data'>
            @csrf
            <table>
                <tbody>
                    <tr>
                        <th class="caption-td">商品名<span class="kome">*</span></th>
                        <td class="input-td">
